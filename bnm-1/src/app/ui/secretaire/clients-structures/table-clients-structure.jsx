...
// Calculate starting and ending index for current page
  ...
  return (
    <>
      ...
      <td className="border text-start py-2 p-2">{index + 1}</td>
      <td className="border text-start py-2 p-2">{name}</td>
      <td className="border text-start py-2 p-2">{email}</td>
      <td className="border text-start py-2 p-2">{phone}</td>
      <td className="border text-center py-2 p-2">{nombre_dossiers}</td>
      <td className="border text-start py-2 p-2">{montant}</td>
      <td className="border text-start py-2 p-2">{create_at}</td>
    </>
  );
};
