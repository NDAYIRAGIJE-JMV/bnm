...
const GenererRapport = ({ closeModalRapport, id }) => {
...
const handleGeneratePDF = async () => {
  ...
  reader.onloadend = () => {
    ...
    const headers = ["Numéro dossier", "Demandeur", "Juridiction", "Date d'audience", "Décision", "Commentaire"];
    ...
    dataRows.forEach(row => {
      ...
      // First, calculate the height of each cell in the row
      ...
      row.forEach((cell, index) => {
        ...
        // Instead of drawing a background rectangle, just draw the text
      ...
      <div className="w-[95%] md:w-[95%] lg:w-[93%] xl:w-[95%] h-[95%] md:h-[97%] xl:h-[98%] relative flex flex-col space-y-3 md:space-y-2 bg-white rounded-md mx-auto rounded-md">
        <div className="w-[98%] h-[5%] flex justify-end mx-auto mt-2">
          <div className="w-[100%] md:w-[30%] xl:w-[25%] h-full flex justify-between items-center">
            ...
            <button onClick={closeModalRapport} className="w-6 h-6 hover:bg-red-600">
              <svg
